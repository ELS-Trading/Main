...
<div id="wrapper">
     ...
     <div class="columns">
         <img src="Images/W1.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/> 
  <ul class="price">
  ...
  <div class="columns">
       <img src="Images/W2.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/> 
  <ul class="price">
    ...
    <li class="grey"><a href="Quotation.php" class="button">Order</a></li>
           ...
           <div class="columns">
               <img src="Images/W3.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/> 
  <ul class="price">
      
    <li class="grey">Extra Length, Average Height</li>
    <li>Price:N$ 7 500.00 (excl VAT)</li>
    <li class="grey"><a href="Quotation.php" class="button">Order</a></li>
  </ul>
 </div>
                 <p></p>
            <div class="columns">
                <img src="Images/W4.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/> 
  <ul class="price">
    ...
    <li class="grey"><a href="Quotation.php" class="button">Order</a></li>
                     ...
                     <div class="columns">
                         <img src="Images/nigerian-trending.jpg" width="340" height="270"  alt="IMG-20170306-WA0034"/> 
  <ul class="price">
      
    <li class="grey">Flattering on average height</li>
    <li>Price:N$ 5 500.00 (excl VAT)</li>
    <li class="grey"><a href="Quotation.php" class="button">Order</a></li>
  </ul>
    </div> 
                 <div class="columns">
                     <img src="Images/W6.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/> 
  <ul class="price">
    ...
    <li class="grey"><a href="Quotation.php" class="button">Order</a></li>
                 ...
                 <div class="columns">
                      <img src="Images/W7.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/> 
  <ul class="price">
    ...
    <li class="grey"><a href="Quotation.php" class="button">Order</a></li>
                 ...
                 <div class="columns">
                     <img src="Images/W8.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/>
  <ul class="price">
    ...
    <li class="grey"><a href="Quotation.php" class="button">Order</a></li>
                 ...
                 <div class="columns">
                      <img src="Images/W9.jpg" width="340" height="270" alt="IMG-20170306-WA0034"/> 
  <ul class="price">
